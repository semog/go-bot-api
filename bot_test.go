...
func TestGetStickerSet(t *testing.T) {
	...
	msg := NewGetStickerSet("teststickerset")
	_, err := bot.Send(msg)
...
func TestSetWebhookWithCert(t *testing.T) {
	...
	wh := NewWebhookWithCert("https://example.com/tg-test/"+bot.Token, "tests/cert.pem")
...
func TestSetWebhookWithoutCert(t *testing.T) {
	...
	wh := NewWebhook("https://example.com/tg-test/" + bot.Token)
	_, err := bot.SetWebhook(wh)
	if err != nil {
		t.Error(err)
		t.Fail()
